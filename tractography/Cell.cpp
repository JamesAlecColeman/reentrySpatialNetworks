...
int cell::getiFib(){return cell::iFib;}
int cell::getjFib(){return cell::jFib;}
int cell::getkFib(){return cell::kFib;}
...
cell::cell(double xx, double yy, double zz, int i, int j, int k){
    cell::x=xx;
    cell::y=yy;
    cell::z=zz;
    cell::state=0;
